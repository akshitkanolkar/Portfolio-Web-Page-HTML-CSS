...
firstName.addEventListener("blur", () => {
    validateInputFields(regexName, firstName, firstNameMessage, firstNameAlert, "First Name"
    );
});
// Validate Last Name
lastName.addEventListener("blur", () => {
    validateInputFields(regexName, lastName, lastNameMessage, lastNameAlert, "Last Name"
    );
});
// Validate Email
...
phoneNumber.addEventListener("blur", () => {
    validateInputFields(regexPhone, phoneNumber, phoneMessage, phoneAlert, "Phone Number");
});
// Validate Dropdown
